...
<body>
   ...
   <!--home content-->
    ...
    <section class="w-full">
        <div class="w-full h-[600px] bg-[url('https://images.unsplash.com/photo-1514195037031-83d60ed3b448?q=80&w=1742&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-no-repeat bg-top flex flex-col justify-center items-center ">
        <!-- Photo by '@insolitus' on Unsplash -->
            <div>
                <h1 class="mb-3 text-white text-center xl:text-5xl lg:text-4xl md:text-4xl sm:text-4xl xs:text-5xl font-bold rounded-sm">Discover Your needs</h1>
            </div>
            <div class="w-full mx-auto">
                <form action="{{ route('items.index') }}" method="GET">
                    <div class="xl:w-1/2 lg:w-[60%] md:w-[70%] sm:w-[70%] xs:w-[90%] mx-auto flex gap-2 md:mt-6 xs:mt-4">
                        <input type="text" class="border border-gray-400 w-full p-2 rounded-md text-xl pl-2 border-none xl:w-[800px] md:w-[600px] sm:w-[400px]"
                                placeholder="search" value="{{ request('search') }}" name="search"/>
                        <button type="submit" class="px-[10px] p-[10px] bg-gradient-to-r from-green-400 to-green-600 text-lg text-white rounded-xl font-semibold hover:bg-gradient-to-r hover:from-green-500 hover:to-green-700">Search</button>
                    </div>
                    <button class="px-[10px] p-[10px] bg-gradient-to-r from-violet-500 to-indigo-700 text-lg text-white rounded-xl font-semibold hover:bg-gradient-to-r hover:from-violet-600 hover:to-indigo-800 block mx-auto w-72 mt-10">Get Started</button>
                </form>
            </div>
        </div>
    </section>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                        ...
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Ali Baba</h3>
                                            <p class="text-gray-500 text-md">Rapper &amp; Entrepreneur</p>
                                        </div>
                                    </div>
                                    <p class="leading-normal text-gray-300 text-md">Lorem epsilon.</p>
                                </div>
                            </a>
                        </div>
                    </li>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                        ...
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Gogeta Goat</h3>
                                            <p class="text-gray-500 text-md">CEO of Universe 7</p>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                            ...
                                            class="w-12 h-12 bg-center bg-cover border rounded-full" alt="Kanye West">
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Sato Kazuma</h3>
                                            <p class="text-gray-500 text-md">Rapper &amp; Entrepreneur</p>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                            ...
                                            class="w-12 h-12 bg-center bg-cover border rounded-full" alt="Tim Cook">
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Aqua Migame</h3>
                                            <p class="text-gray-500 text-md">manager</p>
                                        </div>
                                    </div>
                                    <p class="leading-normal text-gray-300 text-md">Diam quis enim lobortis scelerisque
                                        fermentum dui faucibus in ornare. Donec pretium vulputate sapien nec sagittis
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                        ...
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Sukuna Ryomen</h3>
                                            <p class="text-gray-500 text-md">Among us Creator</p>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                            ...
                                            class="w-12 h-12 bg-center bg-cover border rounded-full" alt="Tim Cook">
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Gojo Satoru</h3>
                                            <p class="text-gray-500 text-md">Half Cooked</p>
                                        </div>
                                    </div>
                                    <p class="leading-normal text-gray-300 text-md">Diam quis enim lobortis scelerisque
                                        fermentum dui faucibus in ornare. Donec pretium vulputate sapien nec sagittis
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                            ...
                                            class="w-12 h-12 bg-center bg-cover border rounded-full" alt="Parag Agrawal">
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Yuta Okotsu</h3>
                                            <p class="text-gray-500 text-md">MiMic</p>
                                        </div>
                                    </div>
                                    <p class="leading-normal text-gray-300 text-md">Enim neque volutpat ac tincidunt vitae
                                        semper. Mattis aliquam faucibus purus in massa tempor. Neque vitae tempus quam
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                            ...
                                            class="w-12 h-12 bg-center bg-cover border rounded-full" alt="Tim Cook">
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Silver Fang</h3>
                                            <p class="text-gray-500 text-md">Martial Artist</p>
                                        </div>
                                    </div>
                                    <p class="leading-normal text-gray-300 text-md">Diam quis enim lobortis scelerisque
                                        fermentum dui faucibus in ornare. Donec pretium vulputate sapien nec sagittis
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                        ...
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Saitama</h3>
                                            <p class="text-gray-500 text-md">Average Guy</p>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                        ...
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Itadori Yuji</h3>
                                            <p class="text-gray-500 text-md">Dead one</p>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                            ...
                                            class="w-12 h-12 bg-center bg-cover border rounded-full" alt="Satya Nadella">
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">fushigoro Megumi</h3>
                                            <p class="text-gray-500 text-md">Dead two</p>
                                        </div>
                                    </div>
                                    <p class="leading-normal text-gray-300 text-md">Tortor dignissim convallis aenean et
                                        tortor at. At ultrices mi tempus imperdiet nulla malesuada. Id cursus metus aliquam
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-4"><img
                                            ...
                                            class="w-12 h-12 bg-center bg-cover border rounded-full" alt="Dan Schulman">
                                        <div>
                                            <h3 class="text-lg font-semibold text-white">Kokisabi Nobara</h3>
                                            <p class="text-gray-500 text-md">Dead Three</p>
                                        </div>
                                    </div>
                                    <p class="leading-normal text-gray-300 text-md">Quam pellentesque nec nam aliquam sem
                                        et tortor consequat id. Enim sit amet venenatis urna cursus.</p>
        ...
        <div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                <div class="max-w-lg">
                    ...
                    <div class="mt-8">
                        <a href="{{ route('about')}}" class="text-blue-500 hover:text-blue-600 font-medium">Learn more about us
